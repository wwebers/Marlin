...
#define STRING_CONFIG_H_AUTHOR "(wwebers, hypercube SKR 1.3, v1.0)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 278.9 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 35, 60 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 80, 900 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0064 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27, 16, 0 }
...
#define SKEW_CORRECTION
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 141.5
    #define XZ_DIAG_BD 141
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     P0_00       // LED driving pin
  //#define NEOPIXEL2_TYPE NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    5
  #define NEOPIXEL_PIXELS 54       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
